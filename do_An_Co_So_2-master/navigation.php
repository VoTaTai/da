...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container nav">
            <a class="navbar-brand text-black" style="color: dodgerblue;" href="../Home_handle/home.php"><img alt="logo"
                    src="../images/logo_icon_whitetext.png" width="60px  "><b>
                </b></a>
            ...
            <form class="d-flex">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <div class="gravatar-wrapper-32 mx-2">
                        <a href="../Profile_handle/profile.php"><img src="../images/avatar.jpg" alt="Avatar"
                                width="50px" class="rounded-circle" style="vertical-align:bottom;"></a>
                    </div>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-black" style="font-size: 20px;" href="#"
