                    ...
                    <div class="detail-job-content">
                        ...
                        <div class="row">
                            <div class="col-8 col-lg-12 pr-0 applyBtn rounded text-center">
                                <a class="btn  w-100 btn-apply-cv" id="applyCV"
                                    userId="<?php echo $_SESSION['user_id']; ?>"
                                    userName="<?php echo $_SESSION['user_name']; ?>"
                                    nameBs="<?php echo $row['name']; ?>" position="<?php echo $row['position'];?>"
                                    img="<?php echo $row['img'];?>" language="<?php echo $row['language'];?>"
            ...
            <div class="col-lg-4 col-md-5 mt-4 mt-sm-0">
                <div class="detail-job border rounded p-4 company-in4 mb-3">
                    ...
                    <div class="detail-job rounded mt-2">
                        <a tittle="greate"
                            href="../Business_handle/businessDetail.php?businessDetail=<?php echo $row['name']; ?>"
                            class="btn btn-outline-primary w-100 btn-about-company btn-out-line btn-clock">Về Chúng
                            tôi</a>
                    </div>
